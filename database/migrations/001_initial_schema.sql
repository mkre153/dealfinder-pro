-- =====================================================
-- DealFinder Pro Database Migration: 001
-- Initial Schema Creation
-- Version: 1.0
-- Date: 2025-10-08
-- =====================================================

-- Migration Framework Comments:
-- This is the initial schema migration for DealFinder Pro.
-- Future migrations should be numbered sequentially (002, 003, etc.)
-- and should only contain incremental changes.
...
VALUES ('1.0', 'Initial schema creation - Migration 001')
...
-- DROP VIEW IF EXISTS vw_sync_statistics;
-- DROP VIEW IF EXISTS vw_recent_matches;
-- DROP VIEW IF EXISTS vw_active_buyers;
-- DROP VIEW IF EXISTS vw_unsynced_properties;
-- DROP VIEW IF EXISTS vw_hot_deals;
-- DROP FUNCTION IF EXISTS get_match_count(INTEGER);
-- DROP FUNCTION IF EXISTS get_properties_by_score_range(INTEGER, INTEGER);
